...
public class BullClass extends JPanel implements Animal
{
	...
	private static final int RIGHT_SIDE_COW=160;
	private static final int UPPER_SIDE_COW=50;
	private static final int LOWER_SIDE_COW=130;
	...
	public void Draw(Graphics2D g2)
	{
		...
		//if bull towards to the left side
		if (CurrentStateLR.equals("left"))
		{
			//body
		...
		//if bull towards to the right side
		else
		{
			//body
