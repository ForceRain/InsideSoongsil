...
class CenterClass extends JPanel implements MyRobot
{
	...
	public void LastColor(String inputColor)
	{
		...
		//System.out.println("Received Color :"+CurrentStateColor);
	}
	...
	public void LastShape(String inputShape)
	{
		...
		isBef=false;
		//System.out.println("Received Shape :"+CurrentState);
	...
	public void draw(Graphics2D g2)
	{
		if (CurrentMoving.equals("Stop"))
		{
			...
			else if (CurrentState.equals("RoundRectangle"))
			{
				...
				g2.fill(obj);
				g2.draw(obj);
				//System.out.println("RoundRectangle Created");
			}
			else
			{
		...
		for (int i=0;i<Container.size();i++)
		{
			...
			//System.out.println(ColorContainer.get(i));
		}
		//System.out.println("ColorContainer size :"+ColorContainer.size());
