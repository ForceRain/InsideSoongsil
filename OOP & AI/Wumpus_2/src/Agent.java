...
class Agent {
	...
	public int chooseAction() {
		return agentFunction.process();
	}
	
	public void setMapInfo() {
		agentFunction.setMap(wumpusWorld.getWumpusWorld());
		agentFunction.setMapSize(worldSize);
		agentFunction.setAgentHead(this.getDirection());
	}
	
	public void startSearching(int heuristic) {
		agentFunction.init(location,heuristic);
		agentFunction.search();
	}
