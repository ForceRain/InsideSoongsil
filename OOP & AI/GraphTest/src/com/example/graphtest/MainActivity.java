		...
		mAdd.setOnClickListener(new View.OnClickListener() 
		{
			public void onClick(View v) 
			{
				...
				try 
				{
					...
					File path=new File("/storage/emulated/0/DCIM/output.png");
					FileOutputStream fileWriter = new FileOutputStream(path);
					bit.compress(Bitmap.CompressFormat.PNG, 100, fileWriter);
					fileWriter.close();
					Log.d("SUCCESS", "save successfully");
				} 
				catch (Exception e) 
				{
					e.printStackTrace();
			...
			mChartView.setOnClickListener(new View.OnClickListener() 
			{
				public void onClick(View v) 
				{
					...
					else 
					{
						...
						+ seriesSelection.getSeriesIndex()+" data point index "+ seriesSelection.getPointIndex()
